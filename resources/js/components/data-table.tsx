...
/**
 * Tableau Paces : séparateurs horizontaux, en-têtes compacts et survol léger.
 */
...
export function DataTable<T>({
    ...
    const [pageSize, setPageSize] = useState<number>(() => {
        ...
        return opts.includes(defaultPageSize)
            ? defaultPageSize
            : DEFAULT_PAGE_SIZE;
    });
    ...
    return (
        <div className="table-wrapper">
                        ...
                        {columns.map((col) => {
                            ...
                            return (
                                <th
                                    key={col.key}
                                    className={[
                                        'border-b border-border px-3 py-3 align-middle text-xs font-bold whitespace-nowrap text-foreground',
                                        col.align === 'right'
                                            ? 'text-right'
                                            : 'text-left',
                                        col.onHeaderClick
            ...
            {paginated && (
                <div className="flex items-center justify-between gap-4 border-t bg-card px-4 py-3 text-xs text-muted-foreground">
